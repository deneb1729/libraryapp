...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_renewal_date_initially_has_date_two_weeks_in_future(self):
        ...
        date_2_weeks_in_future = datetime.date.today() + datetime.timedelta(weeks=2)

        self.assertEqual(
            resp.context["form"].initial["due_back"], date_2_weeks_in_future
        )
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertFormError(
            resp, "form", "due_back", "Invalid date - renewal more than 3 weeks ahead"
        )
